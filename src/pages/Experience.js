...
function Experience() {
    return (
        <div id="experience" class="container1">
            <h3 class="center-text dark-color pb-4">Experience</h3>
            <ul class="grey-bg">
                <li>
                    <article>
                        <a rel="noopener noreferrer" class="grid p-4 overflow-hidden md:grid-cols-5 rounded-xl lg:p-6 xl:grid-cols-12 hover:bg-gray-900">
                            ...
                            <br></br>
                            • Led Back-end development, modernizing an outdated SOAP API to a high-performing REST API with Java
                            Spring Boot. Conducted thorough jUnit testing to ensure robust functionality and optimal performance.
                            <br></br>
                            • Developed and deployed an AWS Glue job using pySpark and SQL to efficiently gather, filter, and securely store
                            10,000+ entries into Amazon S3 Bucket.
                            <br></br>
                            • Skillfully executed Agile tasks, collaborating seamlessly with cross-functional teams using JIRA, Bitbucket, and
                            Kanban methodology for efficient project management.
                            </p>
                        </a>
                    </article>
                </li>
                <li>
                    <article>
                        <a rel="noopener noreferrer" class="grid p-4 overflow-hidden md:grid-cols-5 rounded-xl lg:p-6 xl:grid-cols-12 hover:bg-gray-900">
                            ...
                            <br></br>
                            • Developed connection of application using Electron & Exalt JavaScript Framework with the focus on bundle size
                            and cross-platform compatibility.
                            <br></br>
                            • Managed backend involving Golang gRPC for communication between front-end and back-end.
                            <br></br>
                            • Led a team of 5 developers to complete beta & 1.0 of the project, writing over 10,000+ lines of code.
                            <br></br>
                            • Created and maintained WS, a NodeJS WebSocket Library, for centralized processes to decrease load on user’s machine.
                            </p>
                        </a>
                    </article>
                </li>
                <li>
                    <article>
                        <a rel="noopener noreferrer" class="grid p-4 overflow-hidden md:grid-cols-5 rounded-xl lg:p-6 xl:grid-cols-12 hover:bg-gray-900">
                            ...
                            <br></br>
                            • Recorded data using an EKG into database systems from Excel and improved workflow and organization by 25%.
                            <br></br>
                            • Trained multiple new interns to help reduce work load and increase video output for the company.
                            </p>
                        </a>
                    </article>
                </li>
            ...
            <h3 class="center-text dark-color pb-4" id="education">Education</h3>
            <ul class="grey-bg">
                <li>
                    <article>
                        <a rel="noopener noreferrer" class="grid p-4 overflow-hidden md:grid-cols-5 rounded-xl lg:p-6 xl:grid-cols-12 hover:bg-gray-900">
